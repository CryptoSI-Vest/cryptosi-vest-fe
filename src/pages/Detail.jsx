...
const Detail = () => {
  ...
  return (
    <div className='px-4 py-16 sm:px-12 sm:py-24 flex max-h-screen w-full'>
      <div className='rounded-xl shadow-md px-4 sm:px-12 sm:py-6 py-4 flex flex-col bg-[#6F9BFC33] dark:bg-[#252A3480] border-2 border-[#6F9BFC322] dark:border-black gap-2 flex-grow'>
        <span className='text-center dark:text-white text-primary font-semibold text-3xl'>
          Vesting Contract Details
        </span>
        <div className='flex gap-4 items-center bg-white dark:bg-black rounded-lg py-3 px-6 relative'>
        ...
        <div className='flex flex-col gap-1 mb-2 bg-white dark:bg-black dark:text-white rounded-lg py-3 px-6'>
          <span>
            <strong>Token:</strong> {contract.name}
          </span>
          <span>
